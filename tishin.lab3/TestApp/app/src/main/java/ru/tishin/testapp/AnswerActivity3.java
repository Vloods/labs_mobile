...
public class AnswerActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button = (Button) findViewById(R.id.button_next_question_3);
        button.setEnabled(false);

        RadioGroup radioGroup = (RadioGroup) findViewById(R.id.radiogroup_question_3);
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if(checkedId == -1){
                    ...
                    if(checkedId == R.id.radiobutton_question_3_answer_4){
                        point = 1;
                    } else {
                        point = 0;
                    }
    ...
    public void OnClick(View view){
        Intent intent = new Intent(AnswerActivity3.this, AnswerActivity4.class);
